/* This file should contain only the particular definitions that make Bot9 different from all the other bots.
...
var imageSrcPre = "/TestOne/PlainCam1?bot=9&cam=3&";	// start of string for image URL prior to type=...
var imageSrcPost="&timestamp=";		// end of string for image URL

var cmdString = "/TestOne/Bot9cmd?command=";
...
window.onload = function(){
	...
	document.getElementById("status").innerHTML = "Rover 9 Awaits...";   
    getStatus();
