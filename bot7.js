/* This file should contain only the particular definitions that make Bot8b different from all the other bots.
...
var cmdString = "/TestOne/Bot7cmd?command=";			// Start of URL for the command servlet
...
window.onload = function(){
    ...
    document.getElementById("status").innerHTML = "Rover 7 Abides...";   
    getStatus();
};
...
//	    document.getElementById("status").innerHTML = "Rover 8 Ready !";   
		getStatus();
